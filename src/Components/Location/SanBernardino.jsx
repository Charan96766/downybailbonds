      ...
      <div className="Downy-main-div">
        <div className="los-angeles-container">
          <div className="Downy-bail-bonds-content">
            ...
            <h1 className="Downy-bail-bonds-heading" data-aos="fade-right">Downey Bail Bonds San Bernardino</h1>
            <p className="Downy-bail-bonds-para" data-aos="fade-right">If you need a bail bondsman in San Bernardino, contact Downey Bail Bonds San Bernardino Downtown. Our team of experienced bail bondsmen are available now for free & confidential advice.
            </p>
            ...
            <div className='QandAcolumns'>
              ...
              <div className='questionAnswerBox'>
                ...
                {activeQuestion !== 'question2' && (
                  <div className='qustion' onClick={() => handleClick('question2')}>What happens when you're arrested in San Bernardino Fontana? <img src={Shiva} alt=""
                ...
                {activeQuestion === 'question2' &&
                  <div className='answer' onClick={() => handleClick('question2')}  >Police stations in San Bernardino County book everyone at either West Valley Detention Center or Central Detention Center in San Bernardino. There is no difference between how men and women get booked at the county jail. Jails house both male and female inmates. <img src={Shiva1} alt="" onClick={() => handleClick('question2')} /></div>}
              ...
              <div className='questionAnswerBox'>
                ...
                {activeQuestion === 'question3' &&
                  <div className='answer' onClick={() => handleClick('question3')}  >We serve a number of local areas, including the following: Rancho Cucamonga, Ontario, Upland, Fontana, Rialto, Colton, The Inland Empire and High Desert, Glendora, La Verne, Pomona, San Dimas, Diamond Bar which are all located in Los Angeles County <img src={Shiva1} alt="" onClick={() => handleClick('question3')} /></div>}
              ...
              <div className='questionAnswerBox'>
                ...
                {activeQuestion !== 'question5' && (
                  <div className='qustion' onClick={() => handleClick('question5')}>Do you deal with a certain type of charge? <img src={Shiva} alt=""
                ...
                {activeQuestion === 'question5' &&
                  <div className='answer' onClick={() => handleClick('question5')}  >We see a lot of DUI, domestic violence, robbery, theft, gun charges, assault charges and drug possession. But we deal with many types of charges. Contact us today to see how we can help. <img src={Shiva1} alt="" onClick={() => handleClick('question5')} /></div>}
              ...
              <div className='questionAnswerBox'>
                ...
                {activeQuestion !== 'question8' && (
                  <div className='qustion' onClick={() => handleClick('question8')}>Will Downey Bail Bonds meet clients at a police station or jail? <img src={Shiva} alt=""
                    onClick={() => handleClick('question7')}
                  />
                  </div>
                )}
                ...
                {activeQuestion === 'question8' &&
                  <div className='answer' onClick={() => handleClick('question8')}  >Yes, we can also meet clients at any jail or police station. <img src={Shiva1} alt="" onClick={() => handleClick('question7')} /></div>}

              </div>
              <div className='questionAnswerBox'>

                {activeQuestion !== 'question9' && (
                  <div className='qustion' onClick={() => handleClick('question9')}>What is the fastest way to arrange bail? <img src={Shiva} alt=""
                    onClick={() => handleClick('question7')}
                  />
                  </div>
                )}
                ...
                {activeQuestion === 'question9' &&
                  <div className='answer' onClick={() => handleClick('question9')}  >Bail can be arranged via email or phone. We can also post bail in court if the defendant is still there. <img src={Shiva1} alt="" onClick={() => handleClick('question7')} /></div>}
