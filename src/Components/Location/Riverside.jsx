...
function Riverside() {
      ...
      <div className="Downy-main-div">
        <div className="los-angeles-container">
          <div className="Downy-bail-bonds-content">
            ...
            <h1 className="Downy-bail-bonds-heading" data-aos="fade-right">Downey Bail Bonds Riverside</h1>
            <p className="Downy-bail-bonds-para" data-aos="fade-right">If you need a bail bondsman in Riverside, contact Downey Bail Bonds Riverside Downtown. Our team of experienced bail bondsmen are available now for free & confidential advice.
            </p>
 ...
 <div className='questionAnswerBox'>
   ...
   <div className='qustion' onClick={() => handleClick('question2')}>How long does it take for a person to be released once bond has been posted? <img src={Shiva} alt=""
   ...
   />
       ...
       {activeQuestion === 'question2' &&
       <div className='answer' onClick={() => handleClick('question2')}  >Release time can be in as little as 30 min + depending on the facility. <img src={Shiva1} alt="" onClick={() => handleClick('question2')}/></div>}
 ...
 {activeQuestion !== 'question3' && (
   ...
   />
       ...
       {activeQuestion === 'question3' &&
       <div className='answer' onClick={() => handleClick('question3')}  >We serve a number of local areas, including the following: Riverside, Eastvale, Moreno Valley, Corona, Temecula, Jurupa Valley, Lake Elsinore, Hemet, Murrieta. <img src={Shiva1} alt="" onClick={() => handleClick('question3')}/></div>}
 ...
 {activeQuestion !== 'question4' && (
   ...
   />
       ...
       {activeQuestion === 'question4' &&
       <div className='answer' onClick={() => handleClick('question4')}  >We see a lot of DUI, domestic violence, robbery, theft, gun charges, assault charges and drug possession. But we deal with many types of charges. Contact us today to see how we can help. <img src={Shiva} alt="" onClick={() => handleClick('question4')}/></div>}
              ...
              {activeQuestion !== 'question5' && (
                ...
                />
                    ...
                    {activeQuestion === 'question5' &&
                    <div className='answer' onClick={() => handleClick('question5')}  >Yes, we can also meet clients at any jail or police station. <img src={Shiva1} alt="" onClick={() => handleClick('question5')}/></div>}
              ...
              {activeQuestion !== 'question6' && (
                <div className='qustion' onClick={() => handleClick('question6')}>What is the fastest way to arrange bail? <img src={Shiva} alt=""
                ...
                />
                    ...
                    {activeQuestion === 'question6' &&
                    <div className='answer' onClick={() => handleClick('question6')}  >Bail can be arranged via email or phone. We can also post bail in court if the defendant is still there.<img src={Shiva1} alt="" onClick={() => handleClick('question6')}/></div>}
