    ...
    <>
      ...
      <div className="Downy-main-div">
        <div className="los-angeles-container">
          <div className="Downy-bail-bonds-content">
            ...
            <h1 className="Downy-bail-bonds-heading" data-aos="fade-right">Downey Bail Bonds Los Angeles</h1>
            <p className="Downy-bail-bonds-para" data-aos="fade-right">If you need a bail bondsman in Los Angeles, contact Downey Bail Bonds Los Angeles Downtown. Our team of experienced bail bondsmen are available now for free & confidential advice.
            </p>
      ...
      <div id='losAngelesMainDiv'>
        ...
        <div id="losAngelesDiv">
          ...
          <div id="bailBondsHeading" data-aos="fade-dwon">Los Angeles Bail Bonds Services</div>
...
<div className='qustion' onClick={() => handleClick('question1')} >What happens when you're arrested in LA? <img src={Shiva} alt=""
...
{activeQuestion === 'question1' &&
<div className='answer' onClick={() => handleClick('question1')}  >Once arrested, the individual will go through a booking process, where law enforcement takes their information and conduct a criminal background check. Individuals that are arrested at police departments or sheriff sub stations will remain at those jails until their arraignment date. If they have medical issues and the station can not accommodate, they will be moved to the county jail at Twin Towers.

An individual can post bail after they have been booked. This is the time you can call us immediately as we are open 24/7. Otherwise, you or your loved one would have to wait for a bail hearing. <img src={Shiva1} alt="" onClick={() => handleClick('question1')}/></div>}
...
{activeQuestion === 'question2' &&
<div className='answer' onClick={() => handleClick('question2')}  >In Los Angeles County, the bail amount will depend on the pre-set bail schedule. For example, according to Los Angeles Felony Bail Schedule, bail can range anywhere up to millions of dollars for the most severe offences. It is ultimately up to the judge who will set your bail amount, depending on what offence you are charged with.

In addition to the bail amount set by the judge, there is a service fee for a bail bonds company to post the bail bond for the individual to be released from custody.

Luckily,  Downey Bail Bonds  LA offer a low-price guarantee, so you can be assured you are getting the best deal possible. We offer the best rebates and lowest rates with affordable payment plans tailored to fit your budget. In most cases, we don’t even require a down payment to issue the bond. <img src={Shiva1} alt="" onClick={() => handleClick('question2')}/></div>}
...
{activeQuestion === 'question3' &&
<div className='answer' onClick={() => handleClick('question3')}  >Release time can be in as little as 30 min, depending on the facility. The fastest way to arrange bail is via phone and email. We can also post bail in court if the defendant is still there. <img src={Shiva1} alt="" onClick={() => handleClick('question3')}/></div>}
...
{activeQuestion === 'question4' &&
<div className='answer' onClick={() => handleClick('question4')}  >Release time can be in as little as 30 min, depending on the facility. The fastest way to arrange bail is via phone and email. We can also post bail in court if the defendant is still there. <img src={Shiva} alt="" onClick={() => handleClick('question4')}/></div>}
...
{activeQuestion === 'question5' &&
<div className='answer' onClick={() => handleClick('question5')}  >Bail can be arranged via phone and email a lot faster. We can also post bail in court if the defendant is still there. We can also meet clients at any police station or <img src={Shiva1} alt="" onClick={() => handleClick('question5')}/></div>}
...
<div className='qustion' onClick={() => handleClick('question7')}>What areas does this office serve? <img src={Shiva} alt=""
...
{activeQuestion === 'question7' &&
<div className='answer' onClick={() => handleClick('question7')}  >We serve a number of local areas, including Los Angeles County, Downtown Los Angeles, East Los Angeles, South Central Los Angeles, Hollywood, Long Beach, Norwalk, Downey, Compton, Lakewood, Torrance, El Segundo, Santa Monica, Palos Verdes, San Pedro, Carson, Lynwood, Huntington Park, Inglewood, Alhambra, El Monte, Pasadena, Glendale, Montebello, West Covina and surrounding areas. <img src={Shiva1} alt="" onClick={() => handleClick('question7')}/></div>}
...
<div className='qustion' onClick={() => handleClick('question8')}>Do you deal with a certain type of charge? <img src={Shiva} alt=""
...
{activeQuestion === 'question8' &&
<div className='answer' onClick={() => handleClick('question8')}  >We frequently deal with DUI’s, domestic violence, robbery, theft, gun charges, assault charges and drug possession. But we deal with many types of charges. <img src={Shiva} alt="" onClick={() => handleClick('question8')}/></div>}
